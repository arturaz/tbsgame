...
final case class WObject(
    ...
    populationTower: Option[netmsg.game.WObject.PopulationTower] = None,
    drone: Option[netmsg.game.WObject.Drone] = None,
    warpPrism: Option[netmsg.game.WObject.WarpPrism] = None,
    actionTower: Option[netmsg.game.WObject.ActionTower] = None,
    rocketFrigateDeployed: Option[netmsg.game.WObject.RocketFrigateDeployed] = None
    ...
    lazy val serializedSize: Int = {
      ...
      if (rocketFrigateDeployed.isDefined) { __size += 2 + com.google.protobuf.CodedOutputStream.computeRawVarint32Size(rocketFrigateDeployed.get.serializedSize) + rocketFrigateDeployed.get.serializedSize }
      __size
    }
    def writeTo(output: com.google.protobuf.CodedOutputStream): Unit = {
      ...
      rocketFrigateDeployed.foreach { v => 
    ...
    def mergeFrom(__input: com.google.protobuf.CodedInputStream): netmsg.game.WObject = {
      ...
      var __rocketFrigateDeployed = this.rocketFrigateDeployed
      var _done__ = false
      while (!_done__) {
        ...
        _tag__ match {
          ...
          case 146 =>
            __populationTower = Some(com.trueaccord.scalapb.LiteParser.readMessage(__input, __populationTower.getOrElse(netmsg.game.WObject.PopulationTower.defaultInstance)))
          case 154 =>
            __drone = Some(com.trueaccord.scalapb.LiteParser.readMessage(__input, __drone.getOrElse(netmsg.game.WObject.Drone.defaultInstance)))
          case 162 =>
            __warpPrism = Some(com.trueaccord.scalapb.LiteParser.readMessage(__input, __warpPrism.getOrElse(netmsg.game.WObject.WarpPrism.defaultInstance)))
          case 170 =>
            __actionTower = Some(com.trueaccord.scalapb.LiteParser.readMessage(__input, __actionTower.getOrElse(netmsg.game.WObject.ActionTower.defaultInstance)))
          case 178 =>
            __rocketFrigateDeployed = Some(com.trueaccord.scalapb.LiteParser.readMessage(__input, __rocketFrigateDeployed.getOrElse(netmsg.game.WObject.RocketFrigateDeployed.defaultInstance)))
      ...
      netmsg.game.WObject(
          ...
          rocketFrigateDeployed = __rocketFrigateDeployed
      )
    }
    ...
    def getPopulationTower: netmsg.game.WObject.PopulationTower = populationTower.getOrElse(netmsg.game.WObject.PopulationTower.defaultInstance)
    def clearPopulationTower: WObject = copy(populationTower = None)
    def withPopulationTower(__v: netmsg.game.WObject.PopulationTower): WObject = copy(populationTower = Some(__v))
    def getDrone: netmsg.game.WObject.Drone = drone.getOrElse(netmsg.game.WObject.Drone.defaultInstance)
    def clearDrone: WObject = copy(drone = None)
    def withDrone(__v: netmsg.game.WObject.Drone): WObject = copy(drone = Some(__v))
    def getWarpPrism: netmsg.game.WObject.WarpPrism = warpPrism.getOrElse(netmsg.game.WObject.WarpPrism.defaultInstance)
    def clearWarpPrism: WObject = copy(warpPrism = None)
    def withWarpPrism(__v: netmsg.game.WObject.WarpPrism): WObject = copy(warpPrism = Some(__v))
    def getActionTower: netmsg.game.WObject.ActionTower = actionTower.getOrElse(netmsg.game.WObject.ActionTower.defaultInstance)
    def clearActionTower: WObject = copy(actionTower = None)
    def withActionTower(__v: netmsg.game.WObject.ActionTower): WObject = copy(actionTower = Some(__v))
    def getRocketFrigateDeployed: netmsg.game.WObject.RocketFrigateDeployed = rocketFrigateDeployed.getOrElse(netmsg.game.WObject.RocketFrigateDeployed.defaultInstance)
    def clearRocketFrigateDeployed: WObject = copy(rocketFrigateDeployed = None)
    def withRocketFrigateDeployed(__v: netmsg.game.WObject.RocketFrigateDeployed): WObject = copy(rocketFrigateDeployed = Some(__v))
...
object WObject extends com.trueaccord.scalapb.GeneratedMessageCompanion[WObject]  {
  ...
  def fromFieldsMap(fieldsMap: Map[Int, Any]): netmsg.game.WObject = netmsg.game.WObject(
    ...
    populationTower = fieldsMap.getOrElse(18, None).asInstanceOf[Option[netmsg.game.WObject.PopulationTower]],
    drone = fieldsMap.getOrElse(19, None).asInstanceOf[Option[netmsg.game.WObject.Drone]],
    warpPrism = fieldsMap.getOrElse(20, None).asInstanceOf[Option[netmsg.game.WObject.WarpPrism]],
    actionTower = fieldsMap.getOrElse(21, None).asInstanceOf[Option[netmsg.game.WObject.ActionTower]],
    rocketFrigateDeployed = fieldsMap.getOrElse(22, None).asInstanceOf[Option[netmsg.game.WObject.RocketFrigateDeployed]]
  )
  lazy val descriptor = new Descriptors.MessageDescriptor("WObject", this,
    None, m = Seq(netmsg.game.WObject.Base.descriptor, netmsg.game.WObject.OwnedObj.descriptor, netmsg.game.WObject.Warpable.descriptor, netmsg.game.WObject.Fighter.descriptor, netmsg.game.WObject.Movable.descriptor, netmsg.game.WObject.Asteroid.descriptor, netmsg.game.WObject.Rock.descriptor, netmsg.game.WObject.Crystal.descriptor, netmsg.game.WObject.Brush.descriptor, netmsg.game.WObject.WarpGate.descriptor, netmsg.game.WObject.Extractor.descriptor, netmsg.game.WObject.PopulationTower.descriptor, netmsg.game.WObject.ActionTower.descriptor, netmsg.game.WObject.WarpLinker.descriptor, netmsg.game.WObject.Spawner.descriptor, netmsg.game.WObject.LaserTower.descriptor, netmsg.game.WObject.Corvette.descriptor, netmsg.game.WObject.WarpPrism.descriptor, netmsg.game.WObject.Drone.descriptor, netmsg.game.WObject.Wasp.descriptor, netmsg.game.WObject.Scout.descriptor, netmsg.game.WObject.RayShip.descriptor, netmsg.game.WObject.RocketFrigate.descriptor, netmsg.game.WObject.RocketFrigateDeployed.descriptor, netmsg.game.WObject.Gunship.descriptor, netmsg.game.WObject.Fortress.descriptor, netmsg.game.WObject.VpTower.descriptor),
    e = Seq(),
  ...
  final case class PopulationTower(
      stats: netmsg.game.WObjectStats.PopulationTower,
      base: netmsg.game.WObject.Base,
      owned: netmsg.game.WObject.OwnedObj,
      warpable: netmsg.game.WObject.Warpable
      ...
      def mergeFrom(__input: com.google.protobuf.CodedInputStream): netmsg.game.WObject.PopulationTower = {
        var __stats = this.stats
        var __base = this.base
        var __owned = this.owned
        var __warpable = this.warpable
        ...
        netmsg.game.WObject.PopulationTower(
            stats = __stats,
            base = __base,
            owned = __owned,
            warpable = __warpable
      ...
      def withStats(__v: netmsg.game.WObjectStats.PopulationTower): PopulationTower = copy(stats = __v)
      def withBase(__v: netmsg.game.WObject.Base): PopulationTower = copy(base = __v)
      def withOwned(__v: netmsg.game.WObject.OwnedObj): PopulationTower = copy(owned = __v)
      def withWarpable(__v: netmsg.game.WObject.Warpable): PopulationTower = copy(warpable = __v)
      def getField(__field: Descriptors.FieldDescriptor): Any = {
        __field.number match {
          case 1 => stats
          case 2 => base
      ...
      def companion = netmsg.game.WObject.PopulationTower
  }
  ...
  object PopulationTower extends com.trueaccord.scalapb.GeneratedMessageCompanion[PopulationTower]  {
    ...
    def fromFieldsMap(fieldsMap: Map[Int, Any]): netmsg.game.WObject.PopulationTower = netmsg.game.WObject.PopulationTower(
      stats = fieldsMap(1).asInstanceOf[netmsg.game.WObjectStats.PopulationTower],
      base = fieldsMap(2).asInstanceOf[netmsg.game.WObject.Base],
      owned = fieldsMap(3).asInstanceOf[netmsg.game.WObject.OwnedObj],
      warpable = fieldsMap(4).asInstanceOf[netmsg.game.WObject.Warpable]
    )
    lazy val descriptor = new Descriptors.MessageDescriptor("PopulationTower", this,
      None, m = Seq(),
      e = Seq(),
      f = netmsg.game.InternalFields_game.internalFieldsFor("netmsg.game.WObject.PopulationTower"))
    lazy val defaultInstance = netmsg.game.WObject.PopulationTower(
      stats = netmsg.game.WObjectStats.PopulationTower.defaultInstance,
      base = netmsg.game.WObject.Base.defaultInstance,
      owned = netmsg.game.WObject.OwnedObj.defaultInstance,
      warpable = netmsg.game.WObject.Warpable.defaultInstance
    )
    implicit class PopulationTowerLens[UpperPB](_l: com.trueaccord.lenses.Lens[UpperPB, PopulationTower]) extends com.trueaccord.lenses.ObjectLens[UpperPB, PopulationTower](_l) {
      def stats: com.trueaccord.lenses.Lens[UpperPB, netmsg.game.WObjectStats.PopulationTower] = field(_.stats)((c_, f_) => c_.copy(stats = f_))
      def base: com.trueaccord.lenses.Lens[UpperPB, netmsg.game.WObject.Base] = field(_.base)((c_, f_) => c_.copy(base = f_))
      def owned: com.trueaccord.lenses.Lens[UpperPB, netmsg.game.WObject.OwnedObj] = field(_.owned)((c_, f_) => c_.copy(owned = f_))
      def warpable: com.trueaccord.lenses.Lens[UpperPB, netmsg.game.WObject.Warpable] = field(_.warpable)((c_, f_) => c_.copy(warpable = f_))
    }
  ...
  final case class ActionTower(
      stats: netmsg.game.WObjectStats.ActionTower,
      base: netmsg.game.WObject.Base,
      owned: netmsg.game.WObject.OwnedObj,
      warpable: netmsg.game.WObject.Warpable
      ...
      def mergeFrom(__input: com.google.protobuf.CodedInputStream): netmsg.game.WObject.ActionTower = {
        var __stats = this.stats
        var __base = this.base
        var __owned = this.owned
        var __warpable = this.warpable
        ...
        netmsg.game.WObject.ActionTower(
            stats = __stats,
            base = __base,
            owned = __owned,
            warpable = __warpable
      ...
      def withStats(__v: netmsg.game.WObjectStats.ActionTower): ActionTower = copy(stats = __v)
      def withBase(__v: netmsg.game.WObject.Base): ActionTower = copy(base = __v)
      def withOwned(__v: netmsg.game.WObject.OwnedObj): ActionTower = copy(owned = __v)
      def withWarpable(__v: netmsg.game.WObject.Warpable): ActionTower = copy(warpable = __v)
      def getField(__field: Descriptors.FieldDescriptor): Any = {
        __field.number match {
          case 1 => stats
          case 2 => base
      ...
      def companion = netmsg.game.WObject.ActionTower
  }
  ...
  object ActionTower extends com.trueaccord.scalapb.GeneratedMessageCompanion[ActionTower]  {
    ...
    def fromFieldsMap(fieldsMap: Map[Int, Any]): netmsg.game.WObject.ActionTower = netmsg.game.WObject.ActionTower(
      stats = fieldsMap(1).asInstanceOf[netmsg.game.WObjectStats.ActionTower],
      base = fieldsMap(2).asInstanceOf[netmsg.game.WObject.Base],
      owned = fieldsMap(3).asInstanceOf[netmsg.game.WObject.OwnedObj],
      warpable = fieldsMap(4).asInstanceOf[netmsg.game.WObject.Warpable]
    )
    lazy val descriptor = new Descriptors.MessageDescriptor("ActionTower", this,
      None, m = Seq(),
      e = Seq(),
      f = netmsg.game.InternalFields_game.internalFieldsFor("netmsg.game.WObject.ActionTower"))
    lazy val defaultInstance = netmsg.game.WObject.ActionTower(
      stats = netmsg.game.WObjectStats.ActionTower.defaultInstance,
      base = netmsg.game.WObject.Base.defaultInstance,
      owned = netmsg.game.WObject.OwnedObj.defaultInstance,
      warpable = netmsg.game.WObject.Warpable.defaultInstance
    )
    implicit class ActionTowerLens[UpperPB](_l: com.trueaccord.lenses.Lens[UpperPB, ActionTower]) extends com.trueaccord.lenses.ObjectLens[UpperPB, ActionTower](_l) {
      def stats: com.trueaccord.lenses.Lens[UpperPB, netmsg.game.WObjectStats.ActionTower] = field(_.stats)((c_, f_) => c_.copy(stats = f_))
      def base: com.trueaccord.lenses.Lens[UpperPB, netmsg.game.WObject.Base] = field(_.base)((c_, f_) => c_.copy(base = f_))
      def owned: com.trueaccord.lenses.Lens[UpperPB, netmsg.game.WObject.OwnedObj] = field(_.owned)((c_, f_) => c_.copy(owned = f_))
      def warpable: com.trueaccord.lenses.Lens[UpperPB, netmsg.game.WObject.Warpable] = field(_.warpable)((c_, f_) => c_.copy(warpable = f_))
    }
  ...
  final case class WarpPrism(
      stats: netmsg.game.WObjectStats.WarpPrism,
      base: netmsg.game.WObject.Base,
      owned: netmsg.game.WObject.OwnedObj,
      warpable: netmsg.game.WObject.Warpable,
      movable: netmsg.game.WObject.Movable
      ...
      def mergeFrom(__input: com.google.protobuf.CodedInputStream): netmsg.game.WObject.WarpPrism = {
        var __stats = this.stats
        var __base = this.base
        var __owned = this.owned
        var __warpable = this.warpable
      ...
      def withStats(__v: netmsg.game.WObjectStats.WarpPrism): WarpPrism = copy(stats = __v)
      def withBase(__v: netmsg.game.WObject.Base): WarpPrism = copy(base = __v)
      def withOwned(__v: netmsg.game.WObject.OwnedObj): WarpPrism = copy(owned = __v)
      def withWarpable(__v: netmsg.game.WObject.Warpable): WarpPrism = copy(warpable = __v)
      def withMovable(__v: netmsg.game.WObject.Movable): WarpPrism = copy(movable = __v)
      def getField(__field: Descriptors.FieldDescriptor): Any = {
        __field.number match {
          case 1 => stats
          case 2 => base
      ...
      def companion = netmsg.game.WObject.WarpPrism
  }
  ...
  object WarpPrism extends com.trueaccord.scalapb.GeneratedMessageCompanion[WarpPrism]  {
    ...
    def fromFieldsMap(fieldsMap: Map[Int, Any]): netmsg.game.WObject.WarpPrism = netmsg.game.WObject.WarpPrism(
      stats = fieldsMap(1).asInstanceOf[netmsg.game.WObjectStats.WarpPrism],
      base = fieldsMap(2).asInstanceOf[netmsg.game.WObject.Base],
      owned = fieldsMap(3).asInstanceOf[netmsg.game.WObject.OwnedObj],
      warpable = fieldsMap(4).asInstanceOf[netmsg.game.WObject.Warpable],
      movable = fieldsMap(5).asInstanceOf[netmsg.game.WObject.Movable]
    )
    lazy val descriptor = new Descriptors.MessageDescriptor("WarpPrism", this,
      None, m = Seq(),
      e = Seq(),
      f = netmsg.game.InternalFields_game.internalFieldsFor("netmsg.game.WObject.WarpPrism"))
    lazy val defaultInstance = netmsg.game.WObject.WarpPrism(
      stats = netmsg.game.WObjectStats.WarpPrism.defaultInstance,
      base = netmsg.game.WObject.Base.defaultInstance,
      owned = netmsg.game.WObject.OwnedObj.defaultInstance,
      warpable = netmsg.game.WObject.Warpable.defaultInstance,
      movable = netmsg.game.WObject.Movable.defaultInstance
    ...
    implicit class WarpPrismLens[UpperPB](_l: com.trueaccord.lenses.Lens[UpperPB, WarpPrism]) extends com.trueaccord.lenses.ObjectLens[UpperPB, WarpPrism](_l) {
      def stats: com.trueaccord.lenses.Lens[UpperPB, netmsg.game.WObjectStats.WarpPrism] = field(_.stats)((c_, f_) => c_.copy(stats = f_))
      def base: com.trueaccord.lenses.Lens[UpperPB, netmsg.game.WObject.Base] = field(_.base)((c_, f_) => c_.copy(base = f_))
      def owned: com.trueaccord.lenses.Lens[UpperPB, netmsg.game.WObject.OwnedObj] = field(_.owned)((c_, f_) => c_.copy(owned = f_))
      def warpable: com.trueaccord.lenses.Lens[UpperPB, netmsg.game.WObject.Warpable] = field(_.warpable)((c_, f_) => c_.copy(warpable = f_))
      def movable: com.trueaccord.lenses.Lens[UpperPB, netmsg.game.WObject.Movable] = field(_.movable)((c_, f_) => c_.copy(movable = f_))
    ...
    final val OWNED_FIELD_NUMBER = 3
    final val WARPABLE_FIELD_NUMBER = 4
    final val MOVABLE_FIELD_NUMBER = 5
  }
  
  final case class Drone(
      stats: netmsg.game.WObjectStats.Drone,
      base: netmsg.game.WObject.Base,
      owned: netmsg.game.WObject.OwnedObj,
      warpable: netmsg.game.WObject.Warpable,
      movable: netmsg.game.WObject.Movable
      ...
      def mergeFrom(__input: com.google.protobuf.CodedInputStream): netmsg.game.WObject.Drone = {
        var __stats = this.stats
        var __base = this.base
        var __owned = this.owned
        var __warpable = this.warpable
      ...
      def withStats(__v: netmsg.game.WObjectStats.Drone): Drone = copy(stats = __v)
      def withBase(__v: netmsg.game.WObject.Base): Drone = copy(base = __v)
      def withOwned(__v: netmsg.game.WObject.OwnedObj): Drone = copy(owned = __v)
      def withWarpable(__v: netmsg.game.WObject.Warpable): Drone = copy(warpable = __v)
      def withMovable(__v: netmsg.game.WObject.Movable): Drone = copy(movable = __v)
      def getField(__field: Descriptors.FieldDescriptor): Any = {
        __field.number match {
          case 1 => stats
          case 2 => base
      ...
      def companion = netmsg.game.WObject.Drone
  }
  ...
  object Drone extends com.trueaccord.scalapb.GeneratedMessageCompanion[Drone]  {
    ...
    def fromFieldsMap(fieldsMap: Map[Int, Any]): netmsg.game.WObject.Drone = netmsg.game.WObject.Drone(
      stats = fieldsMap(1).asInstanceOf[netmsg.game.WObjectStats.Drone],
      base = fieldsMap(2).asInstanceOf[netmsg.game.WObject.Base],
      owned = fieldsMap(3).asInstanceOf[netmsg.game.WObject.OwnedObj],
      warpable = fieldsMap(4).asInstanceOf[netmsg.game.WObject.Warpable],
      movable = fieldsMap(5).asInstanceOf[netmsg.game.WObject.Movable]
    ...
    lazy val descriptor = new Descriptors.MessageDescriptor("Drone", this,
      None, m = Seq(),
      e = Seq(),
      f = netmsg.game.InternalFields_game.internalFieldsFor("netmsg.game.WObject.Drone"))
    lazy val defaultInstance = netmsg.game.WObject.Drone(
      stats = netmsg.game.WObjectStats.Drone.defaultInstance,
      base = netmsg.game.WObject.Base.defaultInstance,
      owned = netmsg.game.WObject.OwnedObj.defaultInstance,
      warpable = netmsg.game.WObject.Warpable.defaultInstance,
      movable = netmsg.game.WObject.Movable.defaultInstance
    ...
    implicit class DroneLens[UpperPB](_l: com.trueaccord.lenses.Lens[UpperPB, Drone]) extends com.trueaccord.lenses.ObjectLens[UpperPB, Drone](_l) {
      def stats: com.trueaccord.lenses.Lens[UpperPB, netmsg.game.WObjectStats.Drone] = field(_.stats)((c_, f_) => c_.copy(stats = f_))
      def base: com.trueaccord.lenses.Lens[UpperPB, netmsg.game.WObject.Base] = field(_.base)((c_, f_) => c_.copy(base = f_))
      def owned: com.trueaccord.lenses.Lens[UpperPB, netmsg.game.WObject.OwnedObj] = field(_.owned)((c_, f_) => c_.copy(owned = f_))
      def warpable: com.trueaccord.lenses.Lens[UpperPB, netmsg.game.WObject.Warpable] = field(_.warpable)((c_, f_) => c_.copy(warpable = f_))
      def movable: com.trueaccord.lenses.Lens[UpperPB, netmsg.game.WObject.Movable] = field(_.movable)((c_, f_) => c_.copy(movable = f_))
  ...
  final case class RocketFrigateDeployed(
      stats: netmsg.game.WObjectStats.RocketFrigateDeployed,
      base: netmsg.game.WObject.Base,
      owned: netmsg.game.WObject.OwnedObj,
      fighter: netmsg.game.WObject.Fighter
      ...
      def mergeFrom(__input: com.google.protobuf.CodedInputStream): netmsg.game.WObject.RocketFrigateDeployed = {
        var __stats = this.stats
        var __base = this.base
        var __owned = this.owned
        var __fighter = this.fighter
        ...
        netmsg.game.WObject.RocketFrigateDeployed(
            stats = __stats,
            base = __base,
            owned = __owned,
            fighter = __fighter
      ...
      def withStats(__v: netmsg.game.WObjectStats.RocketFrigateDeployed): RocketFrigateDeployed = copy(stats = __v)
      def withBase(__v: netmsg.game.WObject.Base): RocketFrigateDeployed = copy(base = __v)
      def withOwned(__v: netmsg.game.WObject.OwnedObj): RocketFrigateDeployed = copy(owned = __v)
      def withFighter(__v: netmsg.game.WObject.Fighter): RocketFrigateDeployed = copy(fighter = __v)
      def getField(__field: Descriptors.FieldDescriptor): Any = {
        __field.number match {
          case 1 => stats
          case 2 => base
      ...
      def companion = netmsg.game.WObject.RocketFrigateDeployed
  }
  ...
  object RocketFrigateDeployed extends com.trueaccord.scalapb.GeneratedMessageCompanion[RocketFrigateDeployed]  {
    ...
    def fromFieldsMap(fieldsMap: Map[Int, Any]): netmsg.game.WObject.RocketFrigateDeployed = netmsg.game.WObject.RocketFrigateDeployed(
      stats = fieldsMap(1).asInstanceOf[netmsg.game.WObjectStats.RocketFrigateDeployed],
      base = fieldsMap(2).asInstanceOf[netmsg.game.WObject.Base],
      owned = fieldsMap(3).asInstanceOf[netmsg.game.WObject.OwnedObj],
      fighter = fieldsMap(5).asInstanceOf[netmsg.game.WObject.Fighter]
    )
    lazy val descriptor = new Descriptors.MessageDescriptor("RocketFrigateDeployed", this,
      None, m = Seq(),
      e = Seq(),
      f = netmsg.game.InternalFields_game.internalFieldsFor("netmsg.game.WObject.RocketFrigateDeployed"))
    lazy val defaultInstance = netmsg.game.WObject.RocketFrigateDeployed(
      stats = netmsg.game.WObjectStats.RocketFrigateDeployed.defaultInstance,
      base = netmsg.game.WObject.Base.defaultInstance,
      owned = netmsg.game.WObject.OwnedObj.defaultInstance,
      fighter = netmsg.game.WObject.Fighter.defaultInstance
    )
    implicit class RocketFrigateDeployedLens[UpperPB](_l: com.trueaccord.lenses.Lens[UpperPB, RocketFrigateDeployed]) extends com.trueaccord.lenses.ObjectLens[UpperPB, RocketFrigateDeployed](_l) {
      def stats: com.trueaccord.lenses.Lens[UpperPB, netmsg.game.WObjectStats.RocketFrigateDeployed] = field(_.stats)((c_, f_) => c_.copy(stats = f_))
      def base: com.trueaccord.lenses.Lens[UpperPB, netmsg.game.WObject.Base] = field(_.base)((c_, f_) => c_.copy(base = f_))
      def owned: com.trueaccord.lenses.Lens[UpperPB, netmsg.game.WObject.OwnedObj] = field(_.owned)((c_, f_) => c_.copy(owned = f_))
      def fighter: com.trueaccord.lenses.Lens[UpperPB, netmsg.game.WObject.Fighter] = field(_.fighter)((c_, f_) => c_.copy(fighter = f_))
    }
  ...
  implicit class WObjectLens[UpperPB](_l: com.trueaccord.lenses.Lens[UpperPB, WObject]) extends com.trueaccord.lenses.ObjectLens[UpperPB, WObject](_l) {
    ...
    def populationTower: com.trueaccord.lenses.Lens[UpperPB, netmsg.game.WObject.PopulationTower] = field(_.getPopulationTower)((c_, f_) => c_.copy(populationTower = Some(f_)))
    def optionalPopulationTower: com.trueaccord.lenses.Lens[UpperPB, Option[netmsg.game.WObject.PopulationTower]] = field(_.populationTower)((c_, f_) => c_.copy(populationTower = f_))
    def drone: com.trueaccord.lenses.Lens[UpperPB, netmsg.game.WObject.Drone] = field(_.getDrone)((c_, f_) => c_.copy(drone = Some(f_)))
    def optionalDrone: com.trueaccord.lenses.Lens[UpperPB, Option[netmsg.game.WObject.Drone]] = field(_.drone)((c_, f_) => c_.copy(drone = f_))
    def warpPrism: com.trueaccord.lenses.Lens[UpperPB, netmsg.game.WObject.WarpPrism] = field(_.getWarpPrism)((c_, f_) => c_.copy(warpPrism = Some(f_)))
    def optionalWarpPrism: com.trueaccord.lenses.Lens[UpperPB, Option[netmsg.game.WObject.WarpPrism]] = field(_.warpPrism)((c_, f_) => c_.copy(warpPrism = f_))
    def actionTower: com.trueaccord.lenses.Lens[UpperPB, netmsg.game.WObject.ActionTower] = field(_.getActionTower)((c_, f_) => c_.copy(actionTower = Some(f_)))
    def optionalActionTower: com.trueaccord.lenses.Lens[UpperPB, Option[netmsg.game.WObject.ActionTower]] = field(_.actionTower)((c_, f_) => c_.copy(actionTower = f_))
    def rocketFrigateDeployed: com.trueaccord.lenses.Lens[UpperPB, netmsg.game.WObject.RocketFrigateDeployed] = field(_.getRocketFrigateDeployed)((c_, f_) => c_.copy(rocketFrigateDeployed = Some(f_)))
    def optionalRocketFrigateDeployed: com.trueaccord.lenses.Lens[UpperPB, Option[netmsg.game.WObject.RocketFrigateDeployed]] = field(_.rocketFrigateDeployed)((c_, f_) => c_.copy(rocketFrigateDeployed = f_))
  }
  ...
  final val ROCKET_FRIGATE_DEPLOYED_FIELD_NUMBER = 22
}
